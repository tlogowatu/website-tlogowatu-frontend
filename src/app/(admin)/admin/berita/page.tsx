...
const FormBuatBerita = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setPenulis('');
            setFile(null);
            // Anda bisa juga mereset input file, tapi ini agak tricky di React
        } catch (error: any) {
...
export default function KelolaBeritaPage() {
    return (
        <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Kelola Berita</h1>
            <div className="grid grid-cols-1 gap-8">
                <FormBuatBerita />
                {/* Di sini nanti bisa ditambahkan komponen untuk menampilkan list berita yang sudah ada */}
            </div>
        </div>
    );
}